...
<div id="mychart3" style="width: 1500px; height: 500px;padding-top:50px">
    <script type="text/javascript">
        ...
        var temps3 = <?php echo $temps3; ?>;
        console.log(temps3);
        google.charts.load('current', {'packages':['corechart']});
        google.charts.setOnLoadCallback(drawChart);
        function drawChart() {
            var data = google.visualization.arrayToDataTable(temps3);
            var options = {
                title: 'Temperature',
...
<div id="mychart4" style="width: 1500px; height: 500px;padding-top:50px">
    <script type="text/javascript">
        ...
        var temps4 = <?php echo $temps4; ?>;
        console.log(temps4);
        google.charts.load('current', {'packages':['corechart']});
        google.charts.setOnLoadCallback(drawChart);
        function drawChart() {
            var data = google.visualization.arrayToDataTable(temps4);
            var options = {
                title: 'Temperature',
